...
public class MyTreeSet<E>
{
    ...
    private int countNodesHelper( TreeNode<E> root )
    {
        ...
        return 1 + countNodesHelper( root.getRight() ) + countNodesHelper( root.getLeft() ); // FIX
                                                                                             // THIS!!
    }
    ...
    private int countLeaves( TreeNode<E> root )
    {
        ...
        return countLeaves( root.getLeft() ) + countLeaves( root.getRight() ); // FIX
                                                                               // THIS!!
    }
    ...
    private int height( TreeNode<E> root )
    {
        ...
        return 1 + max( height( root.getLeft() ), height( root.getRight() ) ); // FIX
                                                                               // THIS!!
    }
    ...
    private int width( TreeNode<E> root )
    {
        ...
        return max(
            max( height( root.getLeft() ) + height( root.getRight() ) + 1,
                width( root.getRight() ) ),
            width( root.getLeft() ) );
    }
    ...
    private void accumulate( TreeNode<Integer> root )
    {
        ...
        if ( root.getLeft() != null )
            i += root.getLeft().getValue();
        if ( root.getRight() != null )
            i += root.getRight().getValue();
        root.setValue( i );

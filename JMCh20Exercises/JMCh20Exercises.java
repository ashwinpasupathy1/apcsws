...
public class JMCh20Exercises<E>
{
    ...
    public ListNode<E> removeFirst( ListNode<E> head )
    {
        ...
        head.setNext( null );
        return temp; // TODO fix return value
    }
    ...
    public int sizeFor( ListNode<E> head )
    {
        ...
        return counter; // TODO fix return value
    }
    ...
    {
        ListNode<E> toAdd = new ListNode<E>( value, null );
        ListNode<E> temp = head;
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        {
            newHead = new ListNode<E>( temp.getValue(), newHead );
        }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        ListNode<String> prev = newHead;
        head = head.getNext();
        while ( head != null )
        {
            ListNode<String> newNode = new ListNode<String>( prev.getValue() + head.getValue(),
                null );
    ...
    public ListNode<E> rotate( ListNode<E> head )
    {
        ...
        ListNode<E> original = head.getNext();
        ...
        head.setNext( null );
        previous.setNext( head );
        return original; // TODO fix return value
    }
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        {
            ListNode<String> toInsert = new ListNode<String>( s, head );
            return toInsert;
        }
        ...
        while ( temp.getNext() != null && s.compareTo( temp.getValue() ) >= 0 )
        {

            if ( s.equals( temp.getValue() ) )
            {
                return head;
            }
            if ( s.compareTo( temp.getNext().getValue() ) < 0 )
            {
                ListNode<String> toInsert = new ListNode<String>( s, temp.getNext() );
                temp.setNext( toInsert );
                return head;
            }
            temp = temp.getNext();
        }
        ListNode<String> toInsert = new ListNode<String>( s, null );
        temp.setNext( toInsert );
        return head;
    }
    ...
    public ListNode<E> middleNode( ListNode<E> head )
    {
        ...
        return second; // TODO fix return value
    }
    ...
    {
        ListNode<String> min, toMove;
        for ( ListNode<String> a = head; head != null; head = head.getNext() )
        {
            ...
            while ( toMove != null )
            {
                ...
                if ( toMove.getValue().compareTo( min.getValue() ) < 0 )
                {
                    min = toMove;
                }
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        while ( temp != null && temp != head )
        {
            ...
            {
                ListNode2<Integer> swap = temp.getNext();
                swap.setPrevious( temp.getPrevious() );
                temp.getPrevious().setNext( swap );
                break;
            }
            temp = temp.getNext();
        }
